        ...
        <div class="modal-body">
          <form method="post" action="parentCRUD/create.php" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="mn" name="mn" placeholder="Enter mobile number" required>
              <div class="invalid-feedback">Mobile Number is required</div>
            </div>
            <div class="mb-3">
              <label for="ea_edit" class="col-form-label">Email Address:</label>
              <input type="email" class="form-control" id="ea" name="ea" placeholder="Enter email address" required>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="parentCRUD/update.php" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              <label for="ea_edit" class="col-form-label">Email Address:</label>
              <input type="text" class="form-control" id="ea_edit" name="ea" placeholder="Enter email address" required>
              <div class="invalid-feedback">Email address is required</div>
            </div>
            <div class="mb-3">
              <label for="password_edit" class="col-form-label">Password</label>
