    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="teacherCRUD/create.php" novalidate class="needs-validation">
                    <div class="mb-3">
                        <label for="sectionname" class="col-form-label">First Name:</label>
                        <input type="text" class="form-control" id="firstname" name="fname" required>
                        <div class="invalid-feedback">First name is required</div>
                    </div>

                                        <div class="mb-3">
                        <label for="sectionname" class="col-form-label">Last Name:</label>
                        <input type="text" class="form-control" id="lastname" name="lname" required>
                        <div class="invalid-feedback">Last name is required</div>
                    </div>

                                        <div class="mb-3">
                        <label for="sectionname" class="col-form-label">Mobile Number:</label>
                        <input type="text" class="form-control" id="mobilenumber" name="mn" required>
                        <div class="invalid-feedback">Mobile number is required</div>
                    </div>

                    
                                        <div class="mb-3">
                        <label for="sectionname" class="col-form-label">Email Address:</label>
                        <input type="email" class="form-control" id="emailaddress" name="ea" required>
                        <div class="invalid-feedback">Email address is required</div>
                    </div>

                    
                                        <div class="mb-3">
                        <label for="sectionname" class="col-form-label">birthdate:</label>
                        <input type="date" class="form-control" id="birthdate" name="dob" required>
                        <div class="invalid-feedback">Birthdate is required</div>
                    </div>

                    <div class="mb-3">
                        <label for="sectionname" class="col-form-label">Password:</label>
                        <input type="password" class="form-control" id="birthdate" name="pw" required>
                        <div class="invalid-feedback">password is required</div>
                    </div>

    <div class="mb-3">
    <label for="recipient-name" class="col-form-label">Faculty Type</label>
    <select name="fType" class="form-select" aria-label="Default Select Example" required>
        <?php 
