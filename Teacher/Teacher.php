...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        $query = "SELECT class.*, subject.*,sections.* FROM class INNER JOIN subject ON subject.subjectID = class.subjectID INNER JOIN sections ON sections.sectionID = class.sectionID WHERE subject.facultyID = $facultyID";
